...
<script setup lang="ts">
	...
	onLoad((options) => {
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3Y3XSVFYDy15tHYoA-nIRivyoDAjZjxG3xXC-OPYbus"
			})
		...
		if (options.id === '2') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UfU47yUQMojAZOkPuXTIXadlzhdZdOF84VHnC_Hl-Ks"
			})
