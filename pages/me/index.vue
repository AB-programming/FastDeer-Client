...
<script setup lang="ts">
	...
	onLoad((options) => {
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Uo3XgbBx3MtnL4v3mColbUDBzAiRbjkIs3M6C7F2jYs"
			})
