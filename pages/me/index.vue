...
<script setup lang="ts">
	...
	onLoad((options) => {
		uni.setStorage({
			key: 'token',
			data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..dh5u5wXO4NjEDf46szpErxkq4SRBzuCX0Dc0jOPlTfw"
		})
		...
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..SDwaD-ZrrMN4C013_kFIyzPL45j2DbiEvupg4MDYfaQ"
			})
