...
<script setup lang="ts">
	...
	onLoad((options) => {
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gKxE9ZICsBQhVSaaQxecC4MBrtnTwMZaY07gF5YDqUU"
			})
		...
		if (options.id === '2') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ObTIcVoTL-PC9J6XmU73zhjZt1eICf9-OVrkjEEuA5Q"
			})
