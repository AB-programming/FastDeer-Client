...
<script setup lang="ts">
	...
	onLoad((options) => {
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3W0ffvyf0bUKEnuyveGxS5tT8jMnAPIpJ-ykm6gpjtk"
			})
		...
		if (options.id === '2') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gtAQYdbldMdpbf3qI0PD7n5aKHVefwLeiSfHC6gn8ss"
			})
