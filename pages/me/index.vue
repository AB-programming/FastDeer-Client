...
<script setup lang="ts">
	...
	onLoad((options) => {
		if (options.id === '1') {
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..SgFkO4IBYacL3CBwgERyCabeNoKRpWEJn2xHzAxDjmE"
			})
		...
		if (options.id === '2') {
			...
			uni.setStorage({
				key: 'token',
				data: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..DzeDkiIB1WoYU-4HG17mq1iM8HU2YPHwic3M6L8-92M"
			})
